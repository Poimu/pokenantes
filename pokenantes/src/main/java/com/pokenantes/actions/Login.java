...
//RÈceptionne le POST trylogin
@Action("/trylogin")
// GËre les donnËes reÁues comme un objet JSON
@ParentPackage("json-default")
// Le renvoie sera un objet JSON et non pas une rÈorientation vers une page web.
@Result(type = "json", params = { "includeProperties",
		"msg, " // Renvoie de la liste des produits
				...
				// Renvoie des dÈtails fournisseurs
...
public class Login extends ActionSupport {
	...
	/*
	 * Rappel : Le DAO dans le mod√®le MVC correspond au mod√®le : c'est lui qui
	 * g√®re les donn√©es et acc√®de √† la base de donn√©es.
	 * 
	...
	public String execute() {
		/* on demande au DAO de v√©rifier si le nom/mdp correspondent */
		...
		// pour le test, on renvoie syst√©matiquement la liste des produits
		productsList = dao.fetchProducts();
		msg = "success";
